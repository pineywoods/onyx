...
class StubSandboxManager(SandboxManager):
    ...
    def __init__(self) -> None:
        ...
        self.create_opencode_history_snapshot_returns: bool | object = False
        self.has_opencode_history_snapshot_returns: bool = False
        ...
        self.delete_opencode_session_returns: bool | None = True
        ...
        self.delete_opencode_history_snapshot_silent: bool = True
        ...
        self.has_opencode_history_snapshot_count: int = 0
        self.delete_opencode_history_snapshot_count: int = 0
        ...
        self.last_has_opencode_history_snapshot_payload: dict[str, Any] | None = None
        self.last_delete_opencode_history_snapshot_payload: dict[str, Any] | None = None
    ...
    def create_opencode_history_snapshot(
        ...
        *,
        ...
        self.last_create_opencode_history_snapshot_payload = {
            ...
            "delete_existing_if_empty": delete_existing_if_empty,
        }
    ...
    def has_opencode_history_snapshot(
        ...
        self.has_opencode_history_snapshot_count += 1
        self.last_has_opencode_history_snapshot_payload = {
            "sandbox_id": sandbox_id,
            "tenant_id": tenant_id,
        }
        return self.has_opencode_history_snapshot_returns
    ...
    def delete_opencode_history_snapshot(
        ...
        self.delete_opencode_history_snapshot_count += 1
        self.last_delete_opencode_history_snapshot_payload = {
            "sandbox_id": sandbox_id,
            "tenant_id": tenant_id,
        }
        if not self.delete_opencode_history_snapshot_silent:
            raise _not_configured("delete_opencode_history_snapshot")
    ...
    def delete_opencode_session(
        ...
        if self.delete_opencode_session_returns is None:
            raise _not_configured("delete_opencode_session")
